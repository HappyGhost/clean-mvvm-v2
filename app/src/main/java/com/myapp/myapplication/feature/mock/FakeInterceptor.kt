...
class FakeInterceptor(var context: Context) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (!jsonString.isNullOrEmpty()) {
            return Response.Builder().code(200).message(jsonString).protocol(Protocol.HTTP_1_0)
        ...
        return Response.Builder().code(501).message("not found").protocol(Protocol.HTTP_1_0)
            .addHeader("content-type", "application/json")
            .build()
    }
