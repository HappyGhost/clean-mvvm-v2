...
class GetListProvinceUseCaseImpl(var bankRepository: BankRepository) : BaseUseCase<List<ProvinceInfo>>(), GetListProvinceUseCase {

    var listProvinceMutableLiveData = MutableLiveData<Resource<List<ProvinceInfo>>>()

    override fun resultLiveData(): MutableLiveData<Resource<List<ProvinceInfo>>> = listProvinceMutableLiveData
